...
export const Header: React.FC<Props> = ({ project, views }) => {
	...
	return (
		<header
			ref={ref}
			className="relative isolate overflow-hidden bg-[#0F172A] bg-gradient-to-tl from-[#0F172A] via-cyan-900 from-[#0F172A]"
		>
			<div
			...
			>
				<div className="container flex flex-row-reverse items-center justify-between p-6 mx-auto">
					<div className="flex justify-between gap-8">
						...
						<Link target="_blank" href="https://github.com/incunabula01">
							<Github
			...
			<div className="container mx-auto relative isolate overflow-hidden  py-24 sm:py-32">
				<div className="mx-auto max-w-7xl px-6 lg:px-8 text-center flex flex-col items-center">
					<div className="mx-auto max-w-2xl lg:mx-0">
						<h1 className="text-4xl font-bold text-amber-50 sm:text-6xl font-display">
							{project.title}
						</h1>
						<p className="mt-6 text-lg leading-6 text-cyan-300">
							{project.description}
						</p>
					</div>

					<div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
						<div className="grid grid-cols-1 gap-y-6 gap-x-8 text-base font-semibold leading-7 text-amber-50 sm:grid-cols-2 md:flex lg:gap-x-10">
							{links.map((link) => (
